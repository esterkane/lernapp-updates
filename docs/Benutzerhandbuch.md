...
Für Lesungen ohne Zeitlimit gilt: **Anhören → Antworten → Prüfen → Fortsetzen**. Der Audioclip endet automatisch am hinterlegten Haltepunkt. Wähle deine Antwort und klicke **Antwort prüfen**. Erst dann erscheinen die Lösung und Erklärung dieser Frage. Mit **Weiter zum nächsten Abschnitt** gelangst du zur nächsten Aufgabe; drücke dort Abspielen, um weiterzuhören. Du kannst einen Clip erneut anhören. Dafür müssen passende Hörmarken je Frage hinterlegt sein; ältere Importe können noch einen ganzen Lernabschnitt pro Frage verwenden.
